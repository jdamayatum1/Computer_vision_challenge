function [MOVINGREG] = registerDubaiImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 24-Jun-2025
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',300.000000,'NumOctaves',4,'NumScaleLevels',6);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',300.000000,'NumOctaves',4,'NumScaleLevels',6);
