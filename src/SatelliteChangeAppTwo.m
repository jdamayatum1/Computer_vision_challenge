classdef SatelliteChangeAppTwo < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            currentY = currentY - advancedPanelHeight - spacing;

            % Info Text Area - Adjusted size and positioning
            infoPanelHeight = 70;
            app.infoPanel = uipanel(app.UIFigure, ...
                'Position', [leftPanelX currentY + 100 leftPanelWidth infoPanelHeight], ...
                'BorderType', 'line', ...
                'Title', '');
            ...
            % Visualize Button - Increased size and better positioning
            visualizeButtonHeight = 45;
            app.VisualizeButton = uibutton(app.UIFigure, 'push', ...
                'Text', 'Visualize', ...
                'Position', [leftPanelX currentY + 65 leftPanelWidth visualizeButtonHeight], ...
                'ButtonPushedFcn', @(btn, event) onVisualizeButtonPressed(app), ...
                'FontWeight', 'bold', ...
                'FontSize', 16);

            currentY = currentY - visualizeButtonHeight - spacing;
